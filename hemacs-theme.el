...
(defun hemacs-theme-toggle-variant ()
  (interactive)
  (setq hemacs-theme-variant (if (= hemacs-theme-variant 'light) 'dark 'light))
  (load-theme 'hemacs :no-confirm)
  (when (fboundp 'highlight-tail-reload)
    (highlight-tail-reload)))

(let* ((base00   (if (eq hemacs-theme-variant 'light) "#FFFDE7" "#424242"))
       (base01   (if (eq hemacs-theme-variant 'light) "#B0BEC5" "#757575"))
       (base02   (if (eq hemacs-theme-variant 'light) "#78909C" "#9E9E9E"))
       (base03   (if (eq hemacs-theme-variant 'light) "#455A64" "#E0E0E0"))
       (yellow   (if (eq hemacs-theme-variant 'light) "#FF5722" "#FFFF00"))
       (yellow-1 (if (eq hemacs-theme-variant 'light) "#FFD600" "#FFF59D"))
       (brown    (if (eq hemacs-theme-variant 'light) "#4E342E" "#BCAAA4"))
       (orange   (if (eq hemacs-theme-variant 'light) "#E65100" "#FFECB3"))
       (orange-1 (if (eq hemacs-theme-variant 'light) "#EF6C00" "#FFB74D"))
       (amber    (if (eq hemacs-theme-variant 'light) "#E64A19" "#FFE082"))
       (purple   (if (eq hemacs-theme-variant 'light) "#673AB7" "#E1BEE7"))
       (purple-1 (if (eq hemacs-theme-variant 'light) "#512DA8" "#7E57C2"))
       (blue     (if (eq hemacs-theme-variant 'light) "#42A5F5" "#64B5F6"))
       (blue-1   (if (eq hemacs-theme-variant 'light) "#1E88E5" "#42A5F5"))
       (indigo   (if (eq hemacs-theme-variant 'light) "#5C6BC0" "#C5CAE9"))
       (indigo-1 (if (eq hemacs-theme-variant 'light) "#9FA8DA" "#7986CB"))
       (cyan     (if (eq hemacs-theme-variant 'light) "#26C6DA" "#80DEEA"))
       (cyan-1   (if (eq hemacs-theme-variant 'light) "#00ACC1" "#26C6DA"))
       (teal     (if (eq hemacs-theme-variant 'light) "#26A69A" "#80CBC4"))
       (teal-1   (if (eq hemacs-theme-variant 'light) "#00897B" "#4DB6AC"))
       (green    (if (eq hemacs-theme-variant 'light) "#66BB6A" "#C5E1A5"))
       (lime     (if (eq hemacs-theme-variant 'light) "#9E9D24" "#F4FF81"))
       (red      (if (eq hemacs-theme-variant 'light) "#D50000" "#E57373"))
       (red-1    (if (eq hemacs-theme-variant 'light) "#FF1744" "#E53935"))
       (pink "#F8BBD0")
       (pink+1 "#FF80AB")
  ...
  (apply 'custom-theme-set-faces 'hemacs
         (mapcar
          ...
          `((default :background ,base00 :foreground ,base03)
            ...
            (vertical-border :foreground ,base01)
            ...
            (ace-jump-face-background :foreground ,base01)
            ...
            (parenthesis :foreground ,base01)

            (font-lock-builtin-face :foreground ,cyan)
            (font-lock-comment-face :foreground ,base02)
            ...
            (font-lock-negation-char-face :foreground ,lime)
            (font-lock-preprocessor-face :foreground ,blue)
            (font-lock-regexp-grouping-backslash :foreground ,purple)
            (font-lock-regexp-grouping-construct :foreground ,purple)
            (font-lock-string-face :foreground ,green)
            (font-lock-type-face :foreground ,amber)
            (font-lock-variable-name-face :foreground ,teal)
            (font-lock-warning-face :foreground ,red)

            (mode-line :box (:line-width 4 :color ,base00-2 :style nil)
            ...
            (mode-line-buffer-id :foreground ,base03 :background nil)
            (mode-line-emphasis :foreground ,base02 :slant italic)
            (mode-line-highlight :foreground ,base03 :box nil :weight bold)
            ...
            (helm-buffer-directory :foreground ,orange)
            ...
            (helm-ls-git-modified-and-staged-face :foreground ,amber)
            (helm-ls-git-modified-not-staged-face :foreground ,amber)
            (helm-ls-git-renamed-modified-face :foreground ,amber)
            (helm-ls-git-untracked-face :foreground ,blue)

            (show-paren-match :underline (:style line :color ,pink))
            (show-paren-mismatch :background unspecified :foreground ,red :underline (:style line :color ,red))

            (highlight-symbol-face :foreground unspecified :background unspecified :underline (:style line :color ,base02))
            ...
            (rainbow-delimiters-depth-6-face :foreground ,pink)
            ...
            (rainbow-delimiters-depth-12-face :foreground ,pink+1)
            ...
            (ido-first-match :foreground ,amber :weight bold)
            ...
            (git-gutter:added :foreground ,base02)
            (git-gutter:deleted :foreground ,base02)
            (git-gutter:modified :foreground ,base02)

            (diff-hl-insert :foreground ,base02 :background unspecified)
            (diff-hl-unknown :foreground ,base02 :background uspecified)
            (diff-hl-delete :foreground ,base02 :backgound unspecified)
            (diff-hl-change :foreground ,base02 :background unspecified)
            ...
            (diredp-number :foreground ,amber)
            ...
            (magit-branch-local :foreground ,amber)
            (magit-branch-remote :foreground ,amber)
            (magit-branch-label :foreground ,amber)
            (magit-branch-current :foreground ,amber)
            ...
            (ediff-current-diff-B :foreground ,base03 :background ,lime)
            ...
            (ediff-fine-diff-B :foreground ,base03 :background ,lime :weight bold)
            ...
            (js3-jsdoc-value-face :foreground ,amber)
            ...
            (pulse-highlight-face :background ,yellow-1)
            (pulse-highlight-start-face :background ,yellow-1))))
