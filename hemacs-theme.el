...
(let* ((class '((class color) (min-colors 89)))
       ...
       (orange "#f99157")
       (yellow "#ffcc66")
       (yellow-1 (color-darken-name yellow 33))
       (green "#99cc99")
       ...
       (purple "#cc99cc")
       (purple-1 (color-darken-name purple 33)))
  ...
  (custom-theme-set-faces
   ...
   `(rainbow-delimiters-depth-8-face ((t (:foreground ,base02))))
   `(rainbow-delimiters-depth-9-face ((t (:foreground ,base03))))
   `(rainbow-delimiters-depth-10-face ((t (:foreground ,purple-1))))
   `(rainbow-delimiters-depth-11-face ((t (:foreground ,blue-1))))
   `(rainbow-delimiters-depth-12-face ((t (:foreground ,green-1))))
   ...
   `(diff-hunk-header ((t (:background ,base00+1 :foreground ,purple))))
   ...
   `(paren-face-no-match ((t (:inherit paren-face-mismatch))))
   `(paren-face ((t (:foreground ,base03 :background nil))))
   `(show-paren-match ((t (:background unspecified :foreground nil :underline t :weight bold))))
   `(show-paren-mismatch ((t (:background ,red :foreground ,base00+1 :weight bold))))
   ...
   `(org-hide ((t (:foreground ,base00+1))))
  ...
  (custom-theme-set-variables
   ...
   `(highlight-tail-colors '((,yellow-1 . 0)
                             (,purple-1 . 10)
                             (,base01 . 20)
                             (,base00+1 . 45)
                             (,base00 . 70)))
