...
(let* ((base00 "#2d2d2d")
       ...
       (base00-2 (color-darken-name base00 10))
       (base00+1 (color-lighten-name base00 10))
       (base01 "#393939")
       (base01-1 (color-darken-name base01 2))
       (base01+1 (color-lighten-name base01 2))
       (base02 "#515151")
       (base03 "#747369")
       (base04 "#a09f93")
       (base05 "#d3d0c8")
       ...
       (base07 "#f2f0ec")
       (base08 "#f2777a")
       (base08-1 (color-darken-name base08 10))
       (base09 "#f99157")
       (base0A "#ffcc66")
       (base0A-1 (color-darken-name base0A 33))
       (base0B "#99cc99")
       (base0B-1 (color-darken-name base0B 10))
       (base0C "#66cccc")
       (base0D "#6699cc")
       (base0D-1 (color-darken-name base0D 10))
       (base0E "#cc99cc")
       (base0E-1 (color-darken-name base0E 33))
       (base0F "#d27b53"))
  ...
  (custom-theme-set-faces
   ...
   `(hl-line ((t (:background ,base01-1))))
   `(link ((t (:foreground ,base0D))))
   `(link-visited ((t (:foreground ,base0E))))
   `(minibuffer-prompt ((t (:foreground ,base0D))))
   `(region ((t (:background ,base02))))
   `(vhl/default-face ((t (:background ,base01+1))))
   `(trailing-whitespace ((t (:background ,base01+1 :foreground ,base0A))))
   ...
   `(mode-line ((t (:box (:line-width 4 :color ,base00-2 :style nil)
                         :height 0.9 :background ,base00-2 :foreground ,base04))))
   `(mode-line-inactive ((t (:box (:line-width 4 :color ,base00-1 :style nil)
                                  :height 0.9 :background ,base00-1 :foreground ,base03))))
   ...
   `(anzu-replace-to ((t (:foreground ,base0A :background ,base01))))
   ...
   `(company-tooltip ((t (:background ,base00-1 :foreground ,base04))))
   ...
   `(company-tooltip-search ((t (:foreground ,base0A))))
   ...
   `(swoop-face-target-line ((t (:background ,base02))))
   ...
   `(diff-hl-insert ((t (:foreground ,base0B-1 :background ,base01))))
   `(diff-hl-unknown ((t (:foreground ,base0B-1 :background ,base01))))
   `(diff-hl-delete ((t (:foreground ,base08-1 :background ,base01))))
   `(diff-hl-change ((t (:foreground ,base0D-1 :background ,base01))))
  ...
  (custom-theme-set-variables
   ...
   `(highlight-tail-colors '((,base0A-1 . 0)
                             (,base0E-1 . 10)
                             (,base02 . 20)
                             (,base01 . 45)
                             (,base00 . 70)))
