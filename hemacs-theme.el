...
(let* ((class '((class color) (min-colors 89)))
       ...
       (pink "#FF1493")
       (pink+1 (color-lighten-name "#FF1493" 20))
  ...
  (custom-theme-set-faces
   ...
   `(ace-jump-face-foreground ((t (:foreground ,pink+1 :weight bold))))
   ...
   `(parenthesis ((t (:foreground ,base01))))
   ...
   `(highlight-symbol-face ((t (:foreground unspecified :background unspecified :underline (:style line :color ,base01)))))
